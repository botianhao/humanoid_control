...
```bash
colcon build --packages-up-to humanoid_mujoco_sim
colcon build --packages-up-to humanoid_controllers
colcon build --packages-up-to humanoid_legged_description
...
This humanoid controller is based on the code of pocketxjl's ROS1 version : https://github.com/pocketxjl/humanoid-control?tab=readme-ov-file
